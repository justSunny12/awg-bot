...
SETTINGS_BACKUP = ("💾 <b>Резервное копирование</b>\n\nРасписание автоматического "
                  "резервного копирования и ручной запуск. Куда доставлять копии — в этот "
                  "чат или на ящик бота письмом (только шифрованные).")
...
BACKUP_NEEDS_ENCRYPTION = ("⚠️ По почте уходят только шифрованные копии: в БД приватные ключи "
                           "устройств. Задай BACKUP_KEY или BACKUP_PASSPHRASE в "
                           "/etc/awg-bot/env и перезапусти бота.")
