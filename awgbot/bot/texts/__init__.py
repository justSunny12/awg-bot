...
from .routing import (
    ...
    ping_fmt, gateway_role_line, slot_name, slot_short, slot_status,
    ...
    gateway_install_instructions, SETTINGS_ROUTING_SUBOFF, routing_lists_text,
    routing_users_text, routing_status_line, ROUTING_ABOUT, ROUTING_ABOUT_OFF,
...
__all__ = [
    ...
    "routing_lists_block", "ROUTING_BUNDLE_INTRO", "settings_routing_text",
    ...
    "GATEWAY_STANDBY_CHOOSE_INTRO", "gateway_replace_intro", "gateway_switch_ask",
    "gateway_home_text", "gateway_home_report", "gateway_label_text",
    "GW_INSTALL_URL", "gateway_install_instructions", "SETTINGS_ROUTING_SUBOFF",
    "routing_lists_text", "routing_users_text", "routing_status_line", "ROUTING_ABOUT",
