...
from .routing import (
    ...
    gateway_install_instructions, gateway_lan_ask, gateway_peer_ask, peer_nets_line, GATEWAY_LAN_NO_SUBNET, gateway_router_text, SETTINGS_ROUTING_SUBOFF, routing_lists_text,
...
__all__ = [
    ...
    "GATEWAY_STANDBY_CHOOSE_INTRO", "gateway_replace_intro", "gateway_switch_ask",
    "gateway_home_text", "gateway_home_report", "gateway_label_text", "routing_monitor_text",
    "GW_INSTALL_URL", "gateway_install_instructions", "gateway_lan_ask", "gateway_peer_ask", "peer_nets_line", "GATEWAY_LAN_NO_SUBNET", "gateway_router_text", "SETTINGS_ROUTING_SUBOFF",
