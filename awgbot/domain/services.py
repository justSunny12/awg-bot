...
class Services:
    ...
    _TXT_RT_GW_DOWN = ("🔴 Шлюз условной маршрутизации недоступен. Маркировка снята: "
                       ...
                       "Если началось сразу после обновления — пересобери бандл "
                       "шлюза и переустанови его на той стороне: набор обфускации "
                       "линка обязан совпадать, иначе хендшейк не проходит.")
