...
Доставка на шлюз — по расхождению, а не по расписанию: на каждом снимке и в
...
после разбора тут же раздаются всем сессиям на связи (решение §13 концепта
«синхронизация своих списков»); такт живости остаётся страховкой.
