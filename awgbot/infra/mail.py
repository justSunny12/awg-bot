...
PASSWORD_HINTS: dict[str, str] = {
    ...
    "mail.ru": "нужен «пароль для внешних приложений» (id.mail.ru → Безопасность). С 12.06.2026 "
               "Mail.ru выдаёт его только с подпиской «Mail Space для работы» (от 399 ₽/мес); "
               "у давних ящиков доступ мог остаться бесплатным — проверка входа покажет",
}
