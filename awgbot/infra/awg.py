...
_OBFUSCATION_KEYS = [
    ...
    # Поколение 3.1. Оба СИММЕТРИЧНЫ — их обязан нести и клиентский конфиг:
    # приёмник берёт пакет длиннее ожидаемого, только если RandomTrailers
    # включён у него самого, а HeaderProtectionKey это общий ключ шифрования
    # заголовка. Пока сервер их не задаёт, значения пустые и в конфиг не идут.
    #
    # DisableCookies здесь НЕТ намеренно: он односторонний, клиенту его знать
    # незачем, и попади он в конфиг — стал бы просто мусором на руках у людей.
