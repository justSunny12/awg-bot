...
class Client:
    ...
    created_at: str
    # Тип профиля: owner — обычный, со своей подпиской;
...
@dataclass
class Gateway:
    """Слот шлюза условной маршрутизации: устройство
    ...
    created_at: str = ""
    lan_mode: int = 0               # 0/1: «за шлюзом — без VPN»
...
class Device:
    ...
    # Устройство стоит в слоте шлюза условной маршрутизации:
    ...
    #: гость или обычный клиент. Слот, квота, подписка и
