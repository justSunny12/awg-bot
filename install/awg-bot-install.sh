...
# расписания, сроки подписок, окно ±5 минут канала ВПС ↔ шлюз
# (gwlink.MAX_SKEW_SECONDS). Особенно малина — часов реального времени у неё
# нет. Подробности — README §2, «Время хоста».
#
