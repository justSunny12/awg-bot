...
# канал состояния до ВПС внутри линка; 0 — собрать
...
# чтобы второй слот задавался одной переменной.
...
# Подсети за другими шлюзами: в AllowedIPs
...
HDREOF
        ...
        # «За шлюзом — без VPN»: включена ли функция у
