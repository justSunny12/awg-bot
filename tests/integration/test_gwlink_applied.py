...
он меняет файл в чате админа на строку итога).
...
ответа, человек не знает, применилось ли; итог дошёл дважды — два сообщения
«применено» на одно применение; упавший крючок рвёт сессию — канал в петле
